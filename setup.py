...
with open(path.join(here, 'flatlatex_gui', '__init__.py'), encoding='utf-8') as f:
...
setup(
    ...
    description='GUI of a LaTeX math converter to unicode text',
    ...
    entry_points={
        'console_scripts': [
            "flatlatex-gui=flatlatex_gui.gui:main",
        ],
    },
)
